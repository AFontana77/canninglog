        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              ...
              Contact: <a href="mailto:support@canninglog.com" className="text-green-700 hover:underline">support@canninglog.com</a>
            </p>
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              CanningLog is provided "as is" without warranties of any kind. Anvil Road LLC is not liable for any damages
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions about these terms? Email <a href="mailto:support@canninglog.com" className="text-green-700 hover:underline">support@canninglog.com</a>.
            </p>
          </div>
        </section>
      </main>
