...
/**
 * Email capture for canninglog.com.
 *
...
export function EmailCaptureForm({
  ...
  return (
    <form className="flex flex-col gap-3" onSubmit={onSubmit}>
      ...
      <button
        type="submit"
        className="w-full inline-flex items-center justify-center gap-2 bg-teal-700 text-white font-semibold px-6 py-3 rounded-xl hover:bg-teal-800 transition-colors press-feedback min-h-[48px]"
        disabled={state === 'sending'}
      >
      ...
      <label className="flex items-start gap-2.5 text-sm cursor-pointer opacity-90">
        ...
        />
        <span>Send me the download and occasional canning resources. Unsubscribe anytime.</span>
      </label>
